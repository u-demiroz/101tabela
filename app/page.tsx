  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a" }}>
      ...
      <nav style={{ padding: "20px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #1e1e1e" }}>
        <span style={{ fontWeight: 800, fontSize: 20, color: "#f59e0b" }}>101 Tabela</span>
        <Link href="/privacy" style={{ color: "#94a3b8", fontSize: 14, textDecoration: "none" }}>Gizlilik</Link>
      </nav>
      ...
      <main style={{ maxWidth: 640, margin: "0 auto", padding: "80px 32px", textAlign: "center" }}>
        <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 6vw, 3.5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, marginBottom: 20 }}>
            101 Oyna,<br />
            <span style={{ color: "#f59e0b" }}>Puanları Takip Et</span>
          </h1>
          <p style={{ fontSize: 18, color: "#94a3b8", lineHeight: 1.7, marginBottom: 40 }}>
            Klasik Türk kart oyunu 101 için temiz, hızlı puan takip uygulaması. Oyuncuları ekle, tur tur puan gir, kazananı bul.
          </p>
          <a
            href="https://apps.apple.com/us/app/101-tabela/id6761936487"
            target="_blank"
        ...
        >
          {[
            { emoji: "👥", title: "Çok Oyunculu", desc: "2-8 oyuncu desteği" },
            { emoji: "⚡", title: "Hızlı Kurulum", desc: "Saniyeler içinde başla" },
            { emoji: "📊", title: "Puan Geçmişi", desc: "Tüm turları takip et" },
            { emoji: "🌙", title: "Karanlık Tema", desc: "Gözlere dost tasarım" },
          ].map((f) => (
